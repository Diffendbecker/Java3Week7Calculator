            ...
            public void onClick(View v) {
                ...
                if (plus == true) {
                    ...
                    if((plusResult-(int)plusResult)==0) {
                        ...
                        editTextCalc.setText(plusIntResult + "");
                    }
                    else
                    {
                        editTextCalc.setText(mValueOne + mValueTwo + "");
                    }
                    plus = false;
                }
                ...
                if (minus == true) {
                    ...
                    if((minusResult-(int)minusResult)==0) {
                        ...
                        editTextCalc.setText(minusIntResult + "");
                    }
                    else
                    {
                        editTextCalc.setText(mValueOne - mValueTwo + "");
                ...
                if (multiply == true) {
                    ...
                    if((multiplyResult-(int)multiplyResult)==0) {
                        ...
                        editTextCalc.setText(multiplyIntResult + "");
                    }
                    else
                    {
                        editTextCalc.setText(mValueOne * mValueTwo + "");
                ...
                if (divide == true) {
                    ...
                    if((divideResult-(int)divideResult)==0) {
                        ...
                        editTextCalc.setText(divideIntResult + "");
                    }
                    else
                    {
                        editTextCalc.setText(mValueOne / mValueTwo + "");
